...
const resources = {
  ...
  en: {
    translation: {
      ...
      'dashboard.create_job': 'Post Job',
      'dashboard.stats': 'Statistics',
      'dashboard.applications': 'Applications',
      'dashboard.my_applications': 'My Applications',
      'dashboard.received_applications': 'Received Applications',
      'dashboard.posted_jobs': 'Posted Jobs',
      'dashboard.no_applications': 'No applications',
      'dashboard.no_jobs': 'No jobs posted yet',
      'dashboard.accept': 'Accept',
      'dashboard.reject': 'Reject',
      'dashboard.complete': 'Mark as Complete',
      ...
      'job.salary': 'Salary (SAR)',
      'job.duration_type': 'Duration Type',
      'job.duration_value': 'Work Duration',
      'job.category': 'Category',
      'job.requirements': 'Requirements (one per line)',
      'job.create_title': 'Post New Job',
      'job.edit_title': 'Edit Job',
      'job.post': 'Post Job',
      ...
      'messages.no_conversations_desc': 'No active conversations at the moment',
      'messages.type_message': 'Type your message here...',
      'messages.send': 'Send',
