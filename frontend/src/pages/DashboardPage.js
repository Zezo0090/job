...
import { Briefcase, Clock, Users, TrendingUp, Plus, Check, X, Download, Home, LogOut, Edit, Trash2, MessageCircle } from 'lucide-react';
        ...
        <div className="container">
          <div className="header-content">
            ...
            <div className="header-actions">
              ...
              <Button variant="outline" onClick={() => navigate('/messages')} data-testid="messages-button">
